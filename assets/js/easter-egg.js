...
(function() {
    ...
    window.수강신청 = function(연도, 학기, 시작_시간, 시도_횟수, 수강취소_학수번호_목록, 수강신청_학수번호_목록) {
        ...
        async function tryMultiple() {
            ...
            const interval = setInterval(async () => {
                ...
                console.log(`시도 ${tried}회차 시작!`);
                await tryOnce();
                console.log(`시도 ${tried}회차 종료!`);
    ...
    document.addEventListener('keypress', function(e) {
        ...
        if (inputBuffer === secretCode) {
            ...
            console.log('\n파라미터 설명:');
            console.log('1. 연도: "2025"');
            console.log('2. 학기: "1학기", "2학기", "하계 계절수업", "동계 계절수업"');
            console.log('3. 시작시간: "10:00:00" (24시간 형식)');
            console.log('4. 시도횟수: 30 (숫자)');
            console.log('5. 수강취소 과목: [] (비워두거나 ["HALF9408-1"] 형식)');
            console.log('6. 수강신청 과목: ["HALF9408-1", "HALF9424-1"] (학수번호-분반)');
            inputBuffer = ''; // 버퍼 초기화
        }
    });
